...
- The human-driven `/garm-review` flow renders this skeleton into `docs/3-code-review/CR_wa_vx.y.z.md` as the final committed review.
...
State each section's outcome (passed / passed with caveats / not applicable). One line per section, no expanded prose unless a caveat needs explanation. The section names match the criteria headings in `.claude/skills/garm-review/checklist.md` so a reader can cross-reference what was checked.

- [ ] 1. Functional Requirements — <outcome>
- [ ] 2. Code Quality — <outcome>
- [ ] 3. Architectural Compliance — <outcome>
- [ ] 4. Error Handling — <outcome>
- [ ] 5. Security — <outcome>
