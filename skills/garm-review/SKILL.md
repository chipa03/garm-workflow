...
1. @docs/MIMIR.md — verify architectural compliance
2. Related plan in `docs/1-plans/`
3. Related changelog in `docs/2-changelog/`
4. @.claude/skills/garm-review/checklist.md — **single source of truth** for review criteria, severity classification, and approval gate
...
Render the skeleton from `@.claude/skills/garm-review/cr-template.md`:
